...
Handles two side-effects for every "buy now" signal:
  ...
  2. Log the signal as a new row in the Notion "Memecoin Buy Signals Log" DB.
"""
...
def log_to_notion(
    ...
    """Create a new row in the Memecoin Buy Signals Log database. Returns True on success."""
    headers = {
