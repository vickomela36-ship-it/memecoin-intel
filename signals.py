...
# Thresholds
MIN_1H_CHANGE    = 15.0   # % price gain in last hour
MIN_24H_CHANGE   = 50.0   # % price gain in last 24 h
...
def _classify(pair: dict) -> tuple[str, list[str]]:
    """Return (signal, reasons) for a single pair."""
    ...
    signal = "buy now" if reasons else "hold"
    return signal, reasons


def get_signals() -> list[dict]:
    """Return a list of signal dicts for the top boosted tokens."""
    try:
